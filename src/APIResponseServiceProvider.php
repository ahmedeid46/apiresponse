...
class APIResponseServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // $this->loadViewsFrom(__DIR__.'/../resources/views', 'apiresponse');
        // $this->loadMigrationsFrom(__DIR__.'/../database/migrations');
        // $this->loadRoutesFrom(__DIR__.'/routes.php');

        if ($this->app->runningInConsole()) {
            $this->publishes([
                __DIR__.'/../config/config.php' => config_path('apiresponse.php'),
            ], 'config');
            ...
            // Publishing assets.
            /*$this->publishes([
                __DIR__.'/../resources/assets' => public_path('vendor/apiresponse'),
            ], 'assets');*/
